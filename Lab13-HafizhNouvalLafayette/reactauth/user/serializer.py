...
from .models import CustomUser, Evaluation
import re
...
class EvaluationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Evaluation
        fields = ('id','user','user_detail','course','score','feedback')

    def get_user_detail(self, obj):
        if not obj or not obj.user: return None
        return {'id': obj.user.id, 'email': obj.user.email, 'username': obj.user.username, 'full_name': obj.user.full_name}